...
class StoreMonitoringRequest extends ApiRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'kec_id'                        => 'required|string|max:255',
            'desa_id'                       => 'required|string|max:255',
            'kode_sampel'                   => 'required|string|max:255',
            'monitoring_kegiatan_config_id' => 'required|exists:monitoring_kegiatan_config,id',
