...
|----------|-------|
| **HTTP Method** | `PUT` |
| **URL** | `/api/kantor/kegiatan/monitoring/{id}` |
| **Controller** | `App\Http\Controllers\Api\Kantor\MonitoringKegiatanApiController` |
| **Method** | `update()` |
| **FormRequest** | `App\Http\Requests\Kantor\MonitoringKegiatan\UpdateMonitoringRequest` |
...
| `kegiatan_id` | **Yes** | `foreign_key` | sometimes, required, integer, exists:kegiatan,id |
| `kec_id` | **Yes** | `string` | sometimes, required, string, max:255 |
| `desa_id` | **Yes** | `string` | sometimes, required, string, max:255 |
| `kode_sampel` | **Yes** | `string` | sometimes, required, string, max:255 |
| `monitoring_kegiatan_config_id` | **Yes** | `foreign_key` | sometimes, required, exists:monitoring_kegiatan_config,id |
