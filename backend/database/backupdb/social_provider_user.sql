...
CREATE TABLE IF NOT EXISTS `social_provider_user` (
  ...
  `provider_slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `provider_data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
-- Dumping data for table simantordb.social_provider_user: ~0 rows (approximately)
DELETE FROM `social_provider_user`;
