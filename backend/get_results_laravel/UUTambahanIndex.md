# GET `/kantor/uu-tambahan?per_page=15&page=1`
...
|----------|-------|
| **Method** | `GET` |
| **URL** | `/kantor/uu-tambahan?per_page=15&page=1` |
| **Description** | UU tambahan list |
...
```json
{
    ...
    "links": {
        ...
        "prev_cursor": null,
        "prev_page_url": null,
        "path": "http://127.0.0.1:9001/api/kantor/uu-tambahan"
    },
    "per_page": 15,
    "pagination_info": {
        "total_page": 0,
